...
# Example usage
json_files = ["./competitors/competitors_data.json", "./web_search/analyst_reports.json", "./web_search/web_scraped_data.json", "./web_search/earnings_call.json", "./specific/sec_financial_data.json", "./specific/yahoo_results.json", "./company_summary.json"] 
