...
if __name__ == "__main__":
    ...
    # json_files = ["./competitors/scraped_data.json", "./web_search/analyst_reports.json", "./web_search/earnings_transcripts.json", "./specific/sec_financial_data.json", "./specific/yahoo_results.json"] 

    files = ["./output_pdfs/analyst_reports.pdf", "./output_pdfs/earnings_call.pdf", "./output_pdfs/web_scraped_data.pdf", "./output_pdfs/sec_financial_data.pdf", "./output_pdfs/yahoo_results.pdf", "./output_pdfs/company_summary.pdf"]
